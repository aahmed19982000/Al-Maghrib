...
READABILITY_INSTRUCTION = (
    ...
    "- الكلمات الانتقالية: يوست يتطلب أن تحتوي 30% على الأقل من الجمل على كلمة ربط انتقالية واضحة في "
    "بدايتها أو داخلها - وليس فقط 'حيثما كان طبيعياً'. اجعل هذا هدفاً إلزامياً: ابدأ أو اربط ثلث الجمل "
    "تقريباً بكلمات مثل (بالإضافة إلى ذلك، ومع ذلك، على سبيل المثال، في المقابل، وبالتالي، علاوة على ذلك، "
    "من ناحية أخرى، كما، لكن، إذ، بينما، نتيجة لذلك، وفي السياق ذاته، وتجدر الإشارة إلى أن).\n"
