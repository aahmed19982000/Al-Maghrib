...
class WordPressSiteCreateView(StaffRequiredMixin, CreateView):
    model = WordPressSite
    fields = ['name', 'url', 'username', 'application_password', 'wp_author_id', 'daily_limit', 'is_active', 'sources', 'category_mapping', 'use_rich_formatting', 'heading_color', 'use_internal_links', 'generate_gold_price_articles', 'site_tags', 'use_explainer_style']
